import { ChainId, JSBI, Percent, Token, WETH } from '@marx-dex/marx-dex-v2-sdk'
...
// used to ensure the user doesn't send so much EVMOS so they end up with <.01
export const MIN_ETH: JSBI = JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(16)) // .01 EVMOS
